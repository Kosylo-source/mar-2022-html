...
//             innerDiv.innerHTML= `<h2>User:ID ${item.userId}</h2>
//             <h2>ID: ${item.id}</h2>
...
// Зробити кнопку до кожного поста, при кліку на яку, виводяться в окремий блоку усі коментарі поточного поста
//
// fetch('https://jsonplaceholder.typicode.com/posts')
//     .then(value => value.json())
//     .then(value => {
...
//         }});
//
//Альтернативний варіант розв'язку завдання
// fetch('https://jsonplaceholder.typicode.com/posts')
//     .then(value => value.json())
//     .then(value => {
//         let htmlDivElement = document.createElement('div');
